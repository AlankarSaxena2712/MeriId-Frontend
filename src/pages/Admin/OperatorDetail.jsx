		...
		<div className="mb-28">
			...
			<div className="container px-5 mx-auto">
				<Link to="/admin/operator/list">
					<button
						className="btn btn-primary btn-sm bg-orange-500 border-orange-500 hover:bg-orange-600 hover:border-orange-600 flex gap-2"
						onClick={() => navigate}
					>
						<svg
					...
					<div className="tabs tabs-boxed flex justify-center gap-10 bg-meriWhite">
						<span
							...
							className={`tab tab-lg text-2xl ${
								tabSelected === 0
									? "text-white rounded-md bg-orange-500 border-orange-500 hover:bg-orange-600 hover:border-orange-600"
									: ""
							}`}
						>
							Given Task
